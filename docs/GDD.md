...
| 類型 | 範例技能 |
|---|---|
| 攻擊 | 滾石衝鋒、熔岩爆發、雷霆攻擊、冰晶飛刃、水晶爆裂、星辰墜落 |
| 防禦 | 岩石護盾、水晶結界、能量屏障、鑽石護甲 |
| 輔助 | 治癒、回復、強化、速度提升、防禦提升 |
| 終極 | 世界震動、星核爆裂、時空裂縫、彩虹奇蹟 |

支援技能升級、技能熟練度累積、技能組合（連段加成）、以及與養成好感度連動的「羈絆技能」（僅在好感度達標時解鎖）。
...
好友系統、石頭交換（雙方合意交換，防詐欺需伺服器雙簽確認）、PvP 對戰、公會（共同任務/公會戰）、排行榜、跨玩家共同活動（如社群集氣解鎖世界任務）。
...
- **前 5 分鐘**：完成第一次 AR 掃描 + 捕捉，立刻拿到第一隻石頭夥伴，建立情感連結。
